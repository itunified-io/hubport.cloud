...
const SYSTEM_ROLES: SeedRole[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      P.LOCATION_VIEW,
      P.FIELD_SERVICE_VIEW, P.MEETING_POINTS_VIEW, P.MEETING_POINTS_MANAGE,
      P.SERVICE_MEETINGS_VIEW, P.SERVICE_MEETINGS_MANAGE,
      P.SERVICE_MEETINGS_SIGNUP, P.SERVICE_MEETINGS_CONDUCT,
