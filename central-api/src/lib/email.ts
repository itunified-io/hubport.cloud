...
<body style="font-family: -apple-system, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #050507; color: #e4e4e7;">
  ...
  <div style="padding: 30px 0;">
    ...
    <div style="background: rgba(217,119,6,0.1); border: 1px solid rgba(217,119,6,0.3); border-radius: 10px; padding: 16px; margin: 20px 0;">
      <p style="margin: 0; font-size: 14px;"><strong style="color: #d97706;">Your setup credentials</strong> (Tenant ID and Tunnel Token) are available in your <a href="https://portal-uat.hubport.cloud/portal/login" style="color: #d97706; font-weight: 600;">Tenant Portal</a>. For security, credentials are not sent via email.</p>
    </div>
    ...
    <ol style="line-height: 1.8;">
      ...
      <li>Look up your credentials in the <a href="https://portal-uat.hubport.cloud/portal/login" style="color: #d97706;">Tenant Portal</a></li>
